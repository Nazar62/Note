...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"a109a0b3-cb6e-4e3c-8a91-f71cf00bca06\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [19 x i8] c"com.nazardev.notes\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100672385, ; jnienv_initialize_method_token
	i32 100672384, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.44 = internal constant [20 x i8] c"libaot-Notes.dll.so\00", align 16
@__DSOCacheEntry_name.45 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.SavedState.dll.so\00", align 16
@__DSOCacheEntry_name.46 = internal constant [59 x i8] c"libaot-Microsoft.Extensions.FileProviders.Composite.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [572 x %struct.DSOCacheEntry] [
	...
	; 44
	%struct.DSOCacheEntry {
		i64 1814066507726530523, ; hash 0x192cdbe09ff927db, from name: aot-Notes.dll.so
		i8 0, ; ignore
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([59 x i8], [59 x i8]* @__DSOCacheEntry_name.46, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 47
	%struct.DSOCacheEntry {
	...
	; 109
	%struct.DSOCacheEntry {
		i64 3877047685008760700, ; hash 0x35ce0a53fa329f7c, from name: Notes.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 165
	%struct.DSOCacheEntry {
		i64 6248434630477978300, ; hash 0x56b6e630d7e39abc, from name: Notes
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 189
	%struct.DSOCacheEntry {
		i64 7005184567321019721, ; hash 0x61376a3fb937c549, from name: libaot-Notes
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 321
	%struct.DSOCacheEntry {
		i64 10792702361820530924, ; hash 0x95c7619daad508ec, from name: libaot-Notes.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 504
	%struct.DSOCacheEntry {
		i64 16014947924881793663, ; hash 0xde4086496ef5627f, from name: aot-Notes
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
